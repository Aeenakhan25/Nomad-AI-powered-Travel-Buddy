...
namespace NOMAD.Services
{
    public class DestinationMetadata
    {
        ...
        public double Lat { get; set; } = 33.65;
        public double Lng { get; set; } = 72.9599;
    ...
    public class DashboardService
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(city)) city = "Islamabad";
            if (string.IsNullOrWhiteSpace(country)) country = "Pakistan";
